...
fn impl_packet_trait(ast: &DeriveInput) -> TokenStream {
    ...
    #[cfg(all(feature = "bevy", feature = "client"))]
    {
        ...
        functions.push(quote::quote! {
            fn run_client_schedule(world: &mut World) -> Result<(), bevy_ecs::world::error::TryRunScheduleError>{
    ...
    #[cfg(all(feature = "bevy", feature = "server"))]
    {
        ...
        functions.push(quote::quote! {
            fn run_server_schedule(world: &mut World) -> Result<(), bevy_ecs::world::error::TryRunScheduleError>{
